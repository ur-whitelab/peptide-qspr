...
'''This script plots the motif distributions (one distribution per motif slot) generated by the
 motif model. It assumes all the class distribution files are in the same directory.'''
